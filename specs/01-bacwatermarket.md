...
| Product photography, 2000px square | Original 10 mL vial graphic in `bacwatermarket/assets/bacwater-main.png`. Still Noviq Bio branded; replace when a bacwatermarket-specific render exists. |
