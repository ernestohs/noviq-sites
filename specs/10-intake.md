...
Repo seed stubs are obsolete for legal copy. Transcribe remaining D1 address and D2
from the live policies into this table when auditing intake.

| # | Item | Answer |
| --- | --- | --- |
| D1 | Legal entity name and business address per site | fastpeptidetesting: Lavagoat Wholesale LLC (business address TBD). bacwatermarket / noviqpeptides: TBD |
